...
//       return "USB::Получено: $serialData \n";
//     }
//     log.printLog("USB::Ничего не прочитано!\n");
//     return "USB::Ничего не прочитано!\n";
//   } 

//   String statusUsb() {
//     String info;
//     _ports.isNotEmpty ? info ="Доступные USB порты: $_ports\n" : info = "Нет доступных USB устройств";
//     return '$info \n USB::Статус: ${status.value} \n "USB::Порт: ${_port.toString()}"'
//   } 
// }
