...
/////////////////////////////////////////////////// Начало блока интерфейса
///////////////////////////////////////////////////
Row contanerData(String name, String data, Color col) {
    return Row(
      children: [
 ...
 return Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Flexible(flex: 10, child: getAddRemoveSeriesChart()),
              Flexible(child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceAround,
                crossAxisAlignment: CrossAxisAlignment.center,
                children: chartElement.map((el) => contanerData(el.name ,el.data.last.toString(), el.color)).toList(),)),
            ],
          ),
        );
}
