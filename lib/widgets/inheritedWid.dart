...
class _WidFullState extends State<WidFullNotif> {
  ...
  Widget build(BuildContext context) {
    return Center(
      child: Padding(padding: const EdgeInsets.symmetric(horizontal: 30), child: SimpleCalsWidNotif(model: _model, child: Column(mainAxisSize: MainAxisSize.min, children: [
          const WidgPrNotif1(),
...
class SimpleCalsWidNotif extends InheritedNotifier<SimpleCalcWidgetModelNotif> {
  ...
  SimpleCalsWidNotif({super.key, required this.model, required Widget child}) : super(notifier:model, child: child);
  ...
  Widget build(BuildContext context) {
    return Container(
      child: Column(children: [
        ElevatedButton(onPressed: _incrOne, child: Text('Press1')),
        ElevatedButton(onPressed: _incrTwo, child: Text('Press2')),
        Name(
          valueOne: _valueOne,
          valueTwo: _valueTwo, 
          child: const StWid(),
