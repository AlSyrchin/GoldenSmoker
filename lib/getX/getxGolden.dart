...
//     var info = rootBundle.loadString("data.json");
//     List<dynamic> list = json.decode(await info);
//     return list.map((e) => e).toList();
//   }
// }

// class Lla extends GetxController{
//   var list = [].obs;
...
// Обращение controller.list[index][name]

//Загрузка значений
// Obx((){
// if (_controller.loading == false){return CircularProgressIndocator();}
//else{return _listBills();}
// })
...
// }
// extension ResponsText on double{
